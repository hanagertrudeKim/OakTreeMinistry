...
export default function Footer() {
  return (
    <footer className="bg-[#07403A] text-white pt-10 px-[5vw] mt-[10vh]">
      ...
      <div className='border-t border-white mt-7 flex justify-end py-3'>
        <div className='text-gray-100 text-[14px]'>Copyright 2024. oakTree Ministry inc. all right reserved</div>
      </div>
    </footer>
  );
}
