...
잘 성장하도록 훈련시키고 지지합니다`}
        ...
        <Image
          ...
          width={1280}
          height={500}
          className="w-[100vw] h-[32vw] mt-[5vw] z-40 object-center opacity-100 transform -translate-y-5 transition duration-1000 ease-in-out"
        />
      </div>
      <div className="flex items-baseline ">
        <div className="w-[9vw] border-b-2 border-black" />
        <div className="text-black mt-[88px] pl-[2vw] text-[1vw] font-extrabold sm:text-[3vw]">
          KNOW ABOUT US
        </div>
      </div>
...
2024년, 아이티 대학생들을 위해 Santiago의 UTESA 대학 근처에 YWAM Oak Tree 선교센터를 개설했습니다. 이곳에서는 아이티 유학생들을 대상으로 성경 공부, 영어, 컴퓨터, 한글 등 다양한 활동이 이뤄지고 있습니다. 이들을 그리스도의 제자로 훈련시켜 아이티와 서북 아프리카로 선교의 중추로 보내고자 합니다.`}
        ...
        <Image
          ...
          width={580}
          height={680}
          className="w-[37vw] h-[40vw] sm:w-[90vw] ml-[8vw] object-cover"
        />
      </div>
      ...
      <div className="my-[13vw] mx-[15vw]">
        ...
        <div className="flex font-roboto mt-[8vw] justify-center items-center">
          <div>
          ...
          <Image
            ...
            width={581}
            height={480}
            className="w-[30vw] sm:w-[90vw] ml-[6vw] object-contain"
          />
        </div>
        <div className="flex font-roboto mt-[3vw] justify-center items-center">
          <Image
        ...
        <div className="font-extrabold text-[3vw] mt-[10vw]">OUR TEAM</div>
        <Image
