    ...
    <div>
      <div className="h-[450px] px-[10vw] flex justify-center bg-[url('/image/projectBanner2.jpg')] sm:w-[100vw]">
        <div>
          ...
          <div className="w-[600px] text-[3vw] font-bold ml-[6vw] mt-[85px] leading-snug text-white sm:w-[90vw] sm:text-[30px]">
            우리는 이런 일을 하고 있어요
          </div>
            ...
            <>
              ...
              {project.title === "도르가 미혼모 사역" && (
                <div className="font-NSK mt-[100px] flex flex-col justify-center items-center">
                  ...
                  <div className="flex w-[62vw] justify-between items-cente sm:w-[90vw] sm:flex-col">
